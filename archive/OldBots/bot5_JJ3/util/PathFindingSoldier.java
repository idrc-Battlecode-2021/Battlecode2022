...
public class PathFindingSoldier {
    ...
    public Direction getBestDir(MapLocation target){
        ...
        try{
            ...
            int bestEstimation = 100000;

            int dist30 = (int) Math.sqrt(l30.distanceSquaredTo(target)) + v30;
            if(bestEstimation > dist30){
                bestEstimation = dist30;
                ans = d30;
            }
            int dist31 = (int) Math.sqrt(l31.distanceSquaredTo(target)) + v31;
            if(bestEstimation > dist31){
            	bestEstimation = dist31;
            	ans = d31;
            }
            int dist32 = (int) Math.sqrt(l32.distanceSquaredTo(target)) + v32;
            if(bestEstimation > dist32){
            	bestEstimation = dist32;
            	ans = d32;
            }
            int dist33 = (int) Math.sqrt(l33.distanceSquaredTo(target)) + v33;
            if(bestEstimation > dist33){
            	bestEstimation = dist33;
            	ans = d33;
            }
            int dist34 = (int) Math.sqrt(l34.distanceSquaredTo(target)) + v34;
            if(bestEstimation > dist34){
            	bestEstimation = dist34;
            	ans = d34;
            }
            int dist42 = (int) Math.sqrt(l42.distanceSquaredTo(target)) + v42;
            if(bestEstimation > dist42){
            	bestEstimation = dist42;
            	ans = d42;
            }
            int dist43 = (int) Math.sqrt(l43.distanceSquaredTo(target)) + v43;
            if(bestEstimation > dist43){
            	bestEstimation = dist43;
            	ans = d43;
            }
            int dist44 = (int) Math.sqrt(l44.distanceSquaredTo(target)) + v44;
            if(bestEstimation > dist44){
            	bestEstimation = dist44;
            	ans = d44;
            }
            int dist45 = (int) Math.sqrt(l45.distanceSquaredTo(target)) + v45;
            if(bestEstimation > dist45){
            	bestEstimation = dist45;
            	ans = d45;
            }
            int dist46 = (int) Math.sqrt(l46.distanceSquaredTo(target)) + v46;
            if(bestEstimation > dist46){
            	bestEstimation = dist46;
            	ans = d46;
            }
            int dist47 = (int) Math.sqrt(l47.distanceSquaredTo(target)) + v47;
            if(bestEstimation > dist47){
            	bestEstimation = dist47;
            	ans = d47;
            }
            int dist48 = (int) Math.sqrt(l48.distanceSquaredTo(target)) + v48;
            if(bestEstimation > dist48){
            	bestEstimation = dist48;
            	ans = d48;
            }
            int dist54 = (int) Math.sqrt(l54.distanceSquaredTo(target)) + v54;
            if(bestEstimation > dist54){
            	bestEstimation = dist54;
            	ans = d54;
            }
            int dist55 = (int) Math.sqrt(l55.distanceSquaredTo(target)) + v55;
            if(bestEstimation > dist55){
            	bestEstimation = dist55;
            	ans = d55;
            }
            int dist56 = (int) Math.sqrt(l56.distanceSquaredTo(target)) + v56;
            if(bestEstimation > dist56){
            	bestEstimation = dist56;
            	ans = d56;
            }
            int dist57 = (int) Math.sqrt(l57.distanceSquaredTo(target)) + v57;
            if(bestEstimation > dist57){
            	bestEstimation = dist57;
            	ans = d57;
            }
            int dist58 = (int) Math.sqrt(l58.distanceSquaredTo(target)) + v58;
            if(bestEstimation > dist58){
            	bestEstimation = dist58;
            	ans = d58;
            }
            int dist59 = (int) Math.sqrt(l59.distanceSquaredTo(target)) + v59;
            if(bestEstimation > dist59){
            	bestEstimation = dist59;
            	ans = d59;
            }
            int dist60 = (int) Math.sqrt(l60.distanceSquaredTo(target)) + v60;
            if(bestEstimation > dist60){
            	bestEstimation = dist60;
            	ans = d60;
            }
            int dist61 = (int) Math.sqrt(l61.distanceSquaredTo(target)) + v61;
            if(bestEstimation > dist61){
            	bestEstimation = dist61;
            	ans = d61;
            }
            int dist62 = (int) Math.sqrt(l62.distanceSquaredTo(target)) + v62;
            if(bestEstimation > dist62){
            	bestEstimation = dist62;
            	ans = d62;
            }
            int dist67 = (int) Math.sqrt(l67.distanceSquaredTo(target)) + v67;
            if(bestEstimation > dist67){
            	bestEstimation = dist67;
            	ans = d67;
            }
            int dist68 = (int) Math.sqrt(l68.distanceSquaredTo(target)) + v68;
            if(bestEstimation > dist68){
            	bestEstimation = dist68;
            	ans = d68;
            }
            int dist69 = (int) Math.sqrt(l69.distanceSquaredTo(target)) + v69;
            if(bestEstimation > dist69){
            	bestEstimation = dist69;
            	ans = d69;
            }
            int dist70 = (int) Math.sqrt(l70.distanceSquaredTo(target)) + v70;
            if(bestEstimation > dist70){
            	bestEstimation = dist70;
            	ans = d70;
            }
            int dist71 = (int) Math.sqrt(l71.distanceSquaredTo(target)) + v71;
            if(bestEstimation > dist71){
            	bestEstimation = dist71;
            	ans = d71;
            }
            int dist72 = (int) Math.sqrt(l72.distanceSquaredTo(target)) + v72;
            if(bestEstimation > dist72){
            	bestEstimation = dist72;
            	ans = d72;
            }
            int dist73 = (int) Math.sqrt(l73.distanceSquaredTo(target)) + v73;
            if(bestEstimation > dist73){
            	bestEstimation = dist73;
            	ans = d73;
            }
            int dist74 = (int) Math.sqrt(l74.distanceSquaredTo(target)) + v74;
            if(bestEstimation > dist74){
            	bestEstimation = dist74;
            	ans = d74;
            }
            int dist75 = (int) Math.sqrt(l75.distanceSquaredTo(target)) + v75;
            if(bestEstimation > dist75){
            	bestEstimation = dist75;
            	ans = d75;
            }
            int dist80 = (int) Math.sqrt(l80.distanceSquaredTo(target)) + v80;
            if(bestEstimation > dist80){
            	bestEstimation = dist80;
            	ans = d80;
            }
            int dist81 = (int) Math.sqrt(l81.distanceSquaredTo(target)) + v81;
            if(bestEstimation > dist81){
            	bestEstimation = dist81;
            	ans = d81;
            }
            int dist82 = (int) Math.sqrt(l82.distanceSquaredTo(target)) + v82;
            if(bestEstimation > dist82){
            	bestEstimation = dist82;
            	ans = d82;
            }
            int dist83 = (int) Math.sqrt(l83.distanceSquaredTo(target)) + v83;
            if(bestEstimation > dist83){
            	bestEstimation = dist83;
            	ans = d83;
            }
            int dist84 = (int) Math.sqrt(l84.distanceSquaredTo(target)) + v84;
            if(bestEstimation > dist84){
            	bestEstimation = dist84;
            	ans = d84;
            }
            int dist85 = (int) Math.sqrt(l85.distanceSquaredTo(target)) + v85;
            if(bestEstimation > dist85){
            	bestEstimation = dist85;
            	ans = d85;
            }
            int dist86 = (int) Math.sqrt(l86.distanceSquaredTo(target)) + v86;
            if(bestEstimation > dist86){
            	bestEstimation = dist86;
            	ans = d86;
            }
            int dist87 = (int) Math.sqrt(l87.distanceSquaredTo(target)) + v87;
            if(bestEstimation > dist87){
            	bestEstimation = dist87;
            	ans = d87;
            }
            int dist88 = (int) Math.sqrt(l88.distanceSquaredTo(target)) + v88;
            if(bestEstimation > dist88){
            	bestEstimation = dist88;
            	ans = d88;
            }
            int dist93 = (int) Math.sqrt(l93.distanceSquaredTo(target)) + v93;
            if(bestEstimation > dist93){
            	bestEstimation = dist93;
            	ans = d93;
            }
            int dist94 = (int) Math.sqrt(l94.distanceSquaredTo(target)) + v94;
            if(bestEstimation > dist94){
            	bestEstimation = dist94;
            	ans = d94;
            }
            int dist95 = (int) Math.sqrt(l95.distanceSquaredTo(target)) + v95;
            if(bestEstimation > dist95){
            	bestEstimation = dist95;
            	ans = d95;
            }
            int dist96 = (int) Math.sqrt(l96.distanceSquaredTo(target)) + v96;
            if(bestEstimation > dist96){
            	bestEstimation = dist96;
            	ans = d96;
            }
            int dist97 = (int) Math.sqrt(l97.distanceSquaredTo(target)) + v97;
            if(bestEstimation > dist97){
            	bestEstimation = dist97;
            	ans = d97;
            }
            int dist98 = (int) Math.sqrt(l98.distanceSquaredTo(target)) + v98;
            if(bestEstimation > dist98){
            	bestEstimation = dist98;
            	ans = d98;
            }
            int dist99 = (int) Math.sqrt(l99.distanceSquaredTo(target)) + v99;
            if(bestEstimation > dist99){
            	bestEstimation = dist99;
            	ans = d99;
            }
            int dist100 = (int) Math.sqrt(l100.distanceSquaredTo(target)) + v100;
            if(bestEstimation > dist100){
            	bestEstimation = dist100;
            	ans = d100;
            }
            int dist101 = (int) Math.sqrt(l101.distanceSquaredTo(target)) + v101;
            if(bestEstimation > dist101){
            	bestEstimation = dist101;
            	ans = d101;
            }
            int dist106 = (int) Math.sqrt(l106.distanceSquaredTo(target)) + v106;
            if(bestEstimation > dist106){
            	bestEstimation = dist106;
            	ans = d106;
            }
            int dist107 = (int) Math.sqrt(l107.distanceSquaredTo(target)) + v107;
            if(bestEstimation > dist107){
            	bestEstimation = dist107;
            	ans = d107;
            }
            int dist108 = (int) Math.sqrt(l108.distanceSquaredTo(target)) + v108;
            if(bestEstimation > dist108){
            	bestEstimation = dist108;
            	ans = d108;
            }
            int dist109 = (int) Math.sqrt(l109.distanceSquaredTo(target)) + v109;
            if(bestEstimation > dist109){
            	bestEstimation = dist109;
            	ans = d109;
            }
            int dist110 = (int) Math.sqrt(l110.distanceSquaredTo(target)) + v110;
            if(bestEstimation > dist110){
            	bestEstimation = dist110;
            	ans = d110;
            }
            int dist111 = (int) Math.sqrt(l111.distanceSquaredTo(target)) + v111;
            if(bestEstimation > dist111){
            	bestEstimation = dist111;
            	ans = d111;
            }
            int dist112 = (int) Math.sqrt(l112.distanceSquaredTo(target)) + v112;
            if(bestEstimation > dist112){
            	bestEstimation = dist112;
            	ans = d112;
            }
            int dist113 = (int) Math.sqrt(l113.distanceSquaredTo(target)) + v113;
            if(bestEstimation > dist113){
            	bestEstimation = dist113;
            	ans = d113;
            }
            int dist114 = (int) Math.sqrt(l114.distanceSquaredTo(target)) + v114;
            if(bestEstimation > dist114){
            	bestEstimation = dist114;
            	ans = d114;
            }
            int dist120 = (int) Math.sqrt(l120.distanceSquaredTo(target)) + v120;
            if(bestEstimation > dist120){
            	bestEstimation = dist120;
            	ans = d120;
            }
            int dist121 = (int) Math.sqrt(l121.distanceSquaredTo(target)) + v121;
            if(bestEstimation > dist121){
            	bestEstimation = dist121;
            	ans = d121;
            }
            int dist122 = (int) Math.sqrt(l122.distanceSquaredTo(target)) + v122;
            if(bestEstimation > dist122){
            	bestEstimation = dist122;
            	ans = d122;
            }
            int dist123 = (int) Math.sqrt(l123.distanceSquaredTo(target)) + v123;
            if(bestEstimation > dist123){
            	bestEstimation = dist123;
            	ans = d123;
            }
            int dist124 = (int) Math.sqrt(l124.distanceSquaredTo(target)) + v124;
            if(bestEstimation > dist124){
            	bestEstimation = dist124;
            	ans = d124;
            }
            int dist125 = (int) Math.sqrt(l125.distanceSquaredTo(target)) + v125;
            if(bestEstimation > dist125){
            	bestEstimation = dist125;
            	ans = d125;
            }
            int dist126 = (int) Math.sqrt(l126.distanceSquaredTo(target)) + v126;
            if(bestEstimation > dist126){
            	bestEstimation = dist126;
            	ans = d126;
            }
            int dist134 = (int) Math.sqrt(l134.distanceSquaredTo(target)) + v134;
            if(bestEstimation > dist134){
            	bestEstimation = dist134;
            	ans = d134;
            }
            int dist135 = (int) Math.sqrt(l135.distanceSquaredTo(target)) + v135;
            if(bestEstimation > dist135){
            	bestEstimation = dist135;
            	ans = d135;
            }
            int dist136 = (int) Math.sqrt(l136.distanceSquaredTo(target)) + v136;
            if(bestEstimation > dist136){
            	bestEstimation = dist136;
            	ans = d136;
            }
            int dist137 = (int) Math.sqrt(l137.distanceSquaredTo(target)) + v137;
            if(bestEstimation > dist137){
            	bestEstimation = dist137;
            	ans = d137;
            }
            int dist138 = (int) Math.sqrt(l138.distanceSquaredTo(target)) + v138;
            if(bestEstimation > dist138){
