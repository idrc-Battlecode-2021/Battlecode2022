package bot5_JJ2.robots;

import battlecode.common.*;
import bot5_JJ2.util.Constants;
...
public abstract class Robot {
    ...
    public boolean moveToLowPassability(MapLocation loc) throws GameActionException{
        ...
        for (Direction d: Direction.allDirections()){
            ...
            if (rc.onTheMap(adjacent) && rc.canMove(d) && adjacent.distanceSquaredTo(loc) <= rc.getType().actionRadiusSquared){
