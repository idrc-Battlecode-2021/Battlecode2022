package bot9_JJ2.robots.droids;
...
public class Soldier extends Droid{
    ...
    public void run() throws GameActionException {
        ...
        if (hasMapLocation(45)){
            ...
            soldierMove(target);
        }else if(hasMapLocation(43) && globalSoldierCount > 5){ //Archon Location
            ...
            if (rc.canSenseLocation(target)){
                ...
                if (nearbyBots.length ==0){
                    ...
                    MapLocation archonLoc = decode(35);
                    if(target.equals(archonLoc))rc.writeSharedArray(35,0);
                    target = null;
                    targetType = 0;
                }
            }
