package bot10_MC4.util;

import battlecode.common.*;

import java.util.HashSet;

public class PathFinding30 { //Code adopted from Malott Fat Cats
    ...
    public Direction getBestDirLite(MapLocation target){
        ...
        try{
            ...
            double bestEstimation = 100000;
            double dSQ84 = l84.distanceSquaredTo(target);
            ...
            double dSQ31 = l31.distanceSquaredTo(target);
            double dist31 = Math.sqrt(dSQ31) + v31;
            if(bestEstimation > dist31 && dSQ84 > dSQ31){
                bestEstimation = dist31;
                ans = d31;
            }
            double dSQ32 = l32.distanceSquaredTo(target);
            double dist32 = Math.sqrt(dSQ32) + v32;
            if(bestEstimation > dist32 && dSQ84 > dSQ32){
                bestEstimation = dist32;
                ans = d32;
            }
            double dSQ33 = l33.distanceSquaredTo(target);
            double dist33 = Math.sqrt(dSQ33) + v33;
            ...
            double dSQ67 = l67.distanceSquaredTo(target);
            double dist67 = Math.sqrt(dSQ67) + v67;
            if(bestEstimation > dist67 && dSQ84 > dSQ67){
                bestEstimation = dist67;
                ans = d67;
            }
            double dSQ75 = l75.distanceSquaredTo(target);
            double dist75 = Math.sqrt(dSQ75) + v75;
            if(bestEstimation > dist75 && dSQ84 > dSQ75){
                bestEstimation = dist75;
                ans = d75;
            }
            double dSQ80 = l80.distanceSquaredTo(target);
            double dist80 = Math.sqrt(dSQ80) + v80;
            if(bestEstimation > dist80 && dSQ84 > dSQ80){
                bestEstimation = dist80;
                ans = d80;
            }
            double dSQ88 = l88.distanceSquaredTo(target);
            double dist88 = Math.sqrt(dSQ88) + v88;
            if(bestEstimation > dist88 && dSQ84 > dSQ88){
                bestEstimation = dist88;
                ans = d88;
            }
            double dSQ93 = l93.distanceSquaredTo(target);
            double dist93 = Math.sqrt(dSQ93) + v93;
            if(bestEstimation > dist93 && dSQ84 > dSQ93){
                bestEstimation = dist93;
                ans = d93;
            }
            double dSQ101 = l101.distanceSquaredTo(target);
            double dist101 = Math.sqrt(dSQ101) + v101;
            ...
            double dSQ135 = l135.distanceSquaredTo(target);
            double dist135 = Math.sqrt(dSQ135) + v135;
            if(bestEstimation > dist135 && dSQ84 > dSQ135){
                bestEstimation = dist135;
                ans = d135;
            }
            double dSQ136 = l136.distanceSquaredTo(target);
            double dist136 = Math.sqrt(dSQ136) + v136;
            if(bestEstimation > dist136 && dSQ84 > dSQ136){
                bestEstimation = dist136;
                ans = d136;
            }
            double dSQ137 = l137.distanceSquaredTo(target);
            double dist137 = Math.sqrt(dSQ137) + v137;
