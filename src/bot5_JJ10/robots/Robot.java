...
public abstract class Robot {
    ...
    public MapLocation selectPriorityTarget() throws GameActionException {
        ...
        //RobotInfo[] enemyRobotsSeen = rc.senseNearbyRobots(rc.getType().visionRadiusSquared,myTeam.opponent());
        RobotInfo[] enemyRobots = rc.senseNearbyRobots(rc.getType().actionRadiusSquared, myTeam.opponent());
